...
public class StaticPeram {
	...
	// 替换成你的AK (产品密)
	public final static String accessKeyId = "LTAIiCsjGINE4Kl5";// 你的accessKeyId,填你自己的 上文配置所得  自行配置
	public final static String accessKeySecret = "LOK2Cd2nhDDVd1ZUZYsH6TZZheGCAp";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置
	// 必填:短信签名-可在短信控制台中找到
