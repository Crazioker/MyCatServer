...
/**
 * Servlet implementation class AddCheckItem
 */
@WebServlet("/addCheckItem")
public class AddCheckItem extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int rows = this.checkDao.addCheckItem(check);
			Gson gson = new Gson();
